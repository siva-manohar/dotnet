...
# Docker pull image
docker pull 590183962065.dkr.ecr.us-east-1.amazonaws.com/docker-project:$1

#delete the existing container
docker rm -f dotnet-app

# dokcer run the image
docker run -itd -p 8000:8000 --name dotnet-app 590183962065.dkr.ecr.us-east-1.amazonaws.com/docker-project:$1